            ...
            <div class="tab-content">
                <div class="team-info">
                    ...
                    <form action="{{ route('invites.create', [$team->slug]) }}" method="POST" class="form-inline" role="form">
                        ...
                        <button type="submit" class="btn btn-success pull-right">{{_i('Invite')}}</button>
                    </form>
                </div>
                <div class="row no-container vdivide">
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                        <div class="team-members">
                            <h2 style="border-bottom: 1px solid #eee; padding-bottom: 10px;">{{_i('Members')}} <span class="label label-default" style="margin-left: 16px; padding: 3px 8px; font-weight: 400; display: inline-flex; align-items: center; font-size: 11px;">{{ $members->count() }}</span></h2>
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                        <div class="team-members">
                            <h2 style="border-bottom: 1px solid #eee; padding-bottom: 10px;">{{_i('Pending Invitations')}} @if($invitations->count() > 0) <span class="label label-default" style="margin-left: 16px; padding: 3px 8px; font-weight: 400; display: inline-flex; align-items: center; font-size: 11px;">{{ $invitations->count() }}</span> @endif </h2>
                                        ...
                                        <li class="item">
                                            <a href="#" style="position: relative;">
                                                ...
                                                <div style="position: absolute; right: 10px; top: 8px; color: #c1c1c1;">
                                                    <object><a href="{{ route('invite.destroy', [$team->slug, $invitation->code]) }}" data-method="delete" data-confirm="{{_i('Are you sure?')}}" id="remove-invitation" data-toggle="tooltip" data-placement="top" title="{{_i('Remove Invitation')}}"><i class="fa fa-trash-o fa-fw"></i></a></object>
                                                </div>
                                            </a>
                                        </li>
                                    @endforeach
